...
/* output waypoint -----------------------------------------------------------*/
static void outpoint(FILE *fp, gtime_t time, const double *pos, const char *label, int stat, int outalt, int outtime) {
...
/* save gpx file -------------------------------------------------------------*/
static int savegpx(const char *file, const solbuf_t *solbuf, int outtrk, int outpnt, int outalt, int outtime) {
    FILE *fp;
    double pos[3];
    int i;
 ...
 *-----------------------------------------------------------------------------*/
extern int convgpx(const char *infile, const char *outfile, gtime_t ts, gtime_t te, double tint, int qflg, double *offset, int outtrk, int outpnt,
